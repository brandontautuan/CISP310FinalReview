...
Note that the expression sum += \textit{(ptr++) is the same as first performing sum += }ptr, then
...
\begin{enumerate}
\item 1 TTP implementation
\item 1. 1 Structure definition
\end{enumerate}
...
X\textit{size: X}y 1 +
\begin{enumerate}
\item 1. 2 Accessing members of a structure
\end{enumerate}
